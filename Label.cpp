...
Label::Label(QWidget *parent, const QString &str) : QLabel(str, parent)
{
...
void Label::enableZoom(bool value)
{
	m_zoomEnabled = value;
}
...
void Label::setFontSize(double value)
{
	QFont f = font();
